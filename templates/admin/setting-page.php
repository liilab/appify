    ...
    <div id="wooapp-layout">
        <div class="wooapp-appmaking-area">
            <div class="wooapp-description">
                ...
                <div id="wooapp-create-app-section" class="mt-5 d-none">
                ...
                ?>
                <a href="<?php echo $is_url_exist; ?>" id="wooapp-download-app-button" class="mt-5 btn btn-primary d-none" download>Download App</a>
